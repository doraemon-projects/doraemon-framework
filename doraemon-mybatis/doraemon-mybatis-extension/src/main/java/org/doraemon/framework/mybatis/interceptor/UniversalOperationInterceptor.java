package org.doraemon.framework.mybatis.interceptor;
...
public class UniversalOperationInterceptor implements Interceptor {

    private static final Logger LOGGER = LoggerFactory.getLogger(UniversalOperationInterceptor.class);
